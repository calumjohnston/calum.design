...
$('.analyse-btn').click(function (e) {
    ...
    // Accumulate errors
    var eLoadingBar = $('#analyser-loadingbar-value');
    setTimeout(function () {
        eLoadingBar.html('2 Errors Found');
        setTimeout(function () {
            eLoadingBar.html('3 Errors Found');
            setTimeout(function () {
                eLoadingBar.html('4 Errors Found');
                setTimeout(function () {
                    eLoadingBar.html('6 Errors Found');
                    setTimeout(function () {
                        eLoadingBar.hide();
